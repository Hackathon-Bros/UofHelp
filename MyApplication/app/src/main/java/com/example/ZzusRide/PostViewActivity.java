    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<RidePost, PostViewHolder>(postOptions)
        {
            ...
            protected void onBindViewHolder(@NonNull PostViewHolder holder, int position, @NonNull RidePost model) {
                holder.setPostName("Facebook User");
                holder.setPostDetails("Does anyone wanna meet up in the Spark");
                holder.setPostImage(getApplicationContext(), "https://i0.wp.com/blogtimenow.com/wp-content/uploads/2014/06/hide-facebook-profile-picture-notification.jpg?resize=200%2C200");
